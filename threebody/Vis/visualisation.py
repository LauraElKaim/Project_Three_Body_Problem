...
def visualisation(nbr_images, save_path, x1, y1, z1,
    ...
    """
    Create figures of the trajectories and orbits of each body \n
    and save them in Images directory
    ...
    :param save_path: path in which you want to save the images, \n
    ...
    for t in range(0, t_max, nbr_images):
        ...
        ax.plot(x2[t], y2[t], z2[t], 'o', markersize=5, color='darkred')
